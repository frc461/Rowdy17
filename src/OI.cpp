...
OI::OI() {
    ...
    joystickButton1.reset(new JoystickButton(xbox.get(), 3));
    joystickButton1->WhileHeld(new FireCatapult());
    rollOut.reset(new JoystickButton(xbox.get(), 2));
    rollOut->WhileHeld(new EatBoulders(-1));
    rollIn.reset(new JoystickButton(xbox.get(), 1));
    rollIn->WhileHeld(new EatBoulders(1));
    intakeDown.reset(new JoystickButton(xbox.get(), 5));
    intakeDown->WhileHeld(new RaiseLowerIntake(false));
    intakeUp.reset(new JoystickButton(xbox.get(), 6));
    intakeUp->WhileHeld(new RaiseLowerIntake(true));
    rightDriveJoystick.reset(new Joystick(1));
    
    gear2.reset(new JoystickButton(rightDriveJoystick.get(), 2));
