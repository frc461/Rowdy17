...
std::shared_ptr<Relay> RobotMap::flasherFlashlight;
...
void RobotMap::init() {
    ...
    flasherFlashlight.reset(new Relay(1));
    lw->AddActuator("Flasher", "Flashlight", flasherFlashlight);
    


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    gyro.reset(new ADXRS450_Gyro(SPI::kOnboardCS0));
}
